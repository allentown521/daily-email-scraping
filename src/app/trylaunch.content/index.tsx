...
export default defineContentScript({
  matches: ["https://trylaunch.ai/launches/*"],
  cssInjectionMode: "ui",
  runAt: "document_end",

  async main(ctx) {
    console.log("Content script is running on trylaunch.");
    ...
    setTimeout(async () => {
      ...
      document.querySelectorAll("a").forEach((a) => {
        ...
        if (href && a.innerText.trim() === "" && !href.includes("trylaunch") && href.startsWith("https")) {
          urls.push(href);
        }
      });
