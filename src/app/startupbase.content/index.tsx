...
export default defineContentScript({
  matches: ["https://startupbase.io/launches/daily/*/*/*"],
  cssInjectionMode: "ui",
  runAt: "document_end",

  async main(ctx) {
    console.log("Content script is running on startupbase.");
    ...
    const statusPanelId = "startupbase-status-panel-" + Date.now();
