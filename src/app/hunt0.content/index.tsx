...
export default defineContentScript({
  matches: ["https://hunt0.com/explore?range=day&reference=*"],
  cssInjectionMode: "ui",
  runAt: "document_end",

  async main(ctx) {
    console.log("Content script is running on hunt0.");
    ...
    const statusPanelId = "hunt0-status-panel-" + Date.now();
    ...
    document.querySelectorAll("a").forEach((a) => {
      ...
      if (
        ...
        urls.push(`https://hunt0.com${href}`);
      }
    });
